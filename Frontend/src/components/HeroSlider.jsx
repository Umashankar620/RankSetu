...
const SLIDES = [
  {
    ...
    desc: "Everything you need for NEET counselling — every medical college, every counselling authority, every verified data point, and every admission insight, all in one intelligent platform.",
   ...
   
  {
    ...
    typingPhrase: "Browse 991 Colleges",
    ...
    stats: [{ label: "Colleges Listed", value: "991" }, { label: "Data Fields", value: "20+" }],
  },
